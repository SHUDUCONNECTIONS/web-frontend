  ...
  return (
    <div className="container">
      <div className="form">
        ...
        <button onClick={() => console.log('Button 1 clicked')} className="button">
          <span className="icon">
        ...
        <br />
        <button onClick={() => console.log('Button 2 clicked')} className="button">
          <span className="icon">
        ...
        <br />
        <button onClick={() => console.log('Button 3 clicked')} className="button">
          <span className="icon">
        ...
        <br />
        <button onClick={() => console.log('Button 4 clicked')} className="button">
          <span className="icon">
        ...
        <br />
        <button onClick={() => console.log('Button 5 clicked')} className="button">
          <span className="icon">
        ...
        <br />
        <button onClick={() => console.log('Button 6 clicked')} className="button">
          <span className="icon">
